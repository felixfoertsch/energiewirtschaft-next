...
/// GeLi Gas 2020 (MaKo 2020, gueltig ab 01.02.2020): Lieferantenwechsel Gas
///
/// GeLi Gas process structure hasn't changed fundamentally between versions.
/// Same 6-state pattern with Gas-specific fristen:
/// - Pruefungsfrist NB: 10 WT
/// - Abmeldungsfrist: 5 WT
...
pub fn reduce(state: LfwState, event: LfwEvent) -> Result<ReducerOutput<LfwState>, ProzessFehler> {
	match (state, event) {
		...
		(
			...
			// v2020 Gas Widerspruchsfrist: 5 WT
